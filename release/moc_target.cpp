...
QT_MOC_LITERAL(1, 7, 16), // "targetsIncreased"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 11), // "targetsZero"
QT_MOC_LITERAL(4, 37, 12), // "checkIfReset"
QT_MOC_LITERAL(5, 50, 14), // "increaseTarget"
QT_MOC_LITERAL(6, 65, 15) // "checkClockTimer"

    },
    "Target\0targetsIncreased\0\0targetsZero\0"
    "checkIfReset\0increaseTarget\0checkClockTimer"
};
...
void Target::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->targetsIncreased(); break;
        case 1: _t->targetsZero(); break;
        case 2: _t->checkIfReset(); break;
        case 3: _t->increaseTarget(); break;
        case 4: _t->checkClockTimer(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Target::targetsIncreased)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Target::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Target::targetsZero)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Target::targetsIncreased()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Target::targetsZero()
{
